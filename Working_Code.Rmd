...
The last argument in the above example, `htmltools::htmlEscape` was used to sanitize any characters in the name that might be interpreted as HTML. Don't worry too much about this.
